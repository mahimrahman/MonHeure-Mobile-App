                    ...
                    <View className="space-y-2">
                      <View className="flex-row items-center justify-between">
                        <View className="flex-row items-center">
                          ...
                          <Text className="text-gray-600 dark:text-gray-300 ml-2">Start</Text>
                        </View>
                      ...
                      <View className="flex-row items-center justify-between">
                        <View className="flex-row items-center">
                          ...
                          <Text className="text-gray-600 dark:text-gray-300 ml-2">End</Text>
                        </View>
                        <Text className="text-gray-900 dark:text-white font-medium">
                      ...
                      <View className="flex-row items-center justify-between">
                        <View className="flex-row items-center">
                          ...
                          <Text className="text-gray-600 dark:text-gray-300 ml-2">Duration</Text>
                        </View>
                        <Text className="text-gray-900 dark:text-white font-medium">
      ...
      >
        <View className="flex-1 bg-black bg-opacity-50 justify-center items-center">
          <View className="bg-white dark:bg-gray-800 rounded-xl p-6 m-4 w-80">
            ...
            <View className="space-y-4">
              <View>
                <Text className="text-gray-700 dark:text-gray-300 text-sm mb-2">Start Time</Text>
                <TouchableOpacity className="bg-gray-100 dark:bg-gray-700 p-3 rounded-lg">
              ...
              <View>
                <Text className="text-gray-700 dark:text-gray-300 text-sm mb-2">End Time</Text>
                <TouchableOpacity className="bg-gray-100 dark:bg-gray-700 p-3 rounded-lg">
                  <Text className="text-gray-900 dark:text-white">
              ...
              <View>
                <Text className="text-gray-700 dark:text-gray-300 text-sm mb-2">Notes</Text>
                <TouchableOpacity className="bg-gray-100 dark:bg-gray-700 p-3 rounded-lg">
                  <Text className="text-gray-900 dark:text-white">
                    {editNotes || 'Add notes...'}
                  </Text>
